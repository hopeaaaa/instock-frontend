                ...
                <div className="modal-overlay">
                    <div className="modal delete-modal">
                        <div className="delete-modal__content">
                            <button className="delete-modal__close-btn"  onClick={()=>{setShowDelete(false)}}>
                            ...
                            <div className="delete-modal__header"><h2>Delete {item.warehouse_name} warehouse?</h2></div>
                            <div className="delete-modal__body">
                                <p>Please confirm that you'd like to delete the {item.warehouse_name} from the list of warehouses.</p>
