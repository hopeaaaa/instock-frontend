    ...
    <div className="inventory-list">
      ...
      <div className="inventory-list__item-wrapper">
        <div className="inventory-list__item inventory-list__item--subheader">
          <div className="inventory-list__details inventory-list__details--two">
          ...
          <div className="inventory-list__details inventory-list__details--three">
            <div className="inventory-list__detail">
              <h4 className="inventory-list__column-header">
                STATUS{" "}
                <svg
              ...
              <div className="inventory-list__details inventory-list__details--three">
                <div className="inventory-list__detail">
                  ...
                  <ul>
                    <li
                      className={
                        "inventory-list__status inventory-list__status--" +
                        stockClassName
                      }
                    >
                      {item.status}
