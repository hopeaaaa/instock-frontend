...
const InventoryDetail = () => {
    ...
    useEffect(()=>{
     ...
     let stockClassName = data.status !== "Out of Stock" ? 'in-stock' : 'out-of-stock'
    ...
    return (
        <main className="inventory-details">
            ...
            <header className="inventory-details__header">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="inventory-details__edit-button--icon">
                    ...
                    <div className="inventory-details__section inventory-details__section--column">
                        <div className="inventory-details__status">
                            <div className="inventory-details__section">
                                ...
                                <p className={"inventory-details__description inventory-details__description--"+stockClassName}>{data.status}</p>
                            </div>
                        </div>
                        <div className="inventory-details__section">
                            <div className="inventory-details__quantity">
                                <h2 className="inventory-details__title">QUANTITY:</h2>
                                <p className="inventory-details__description">{data.quantity}</p>
                            </div>
                        </div>
                    </div>
                    <div className="inventory-details__section">
                        <h2 className="inventory-details__title">WAREHOUSE:</h2>
                        <p className="inventory-details__description">{data.warehouse_id}</p>
                    </div>
                </div>
            </article>
        </main>
